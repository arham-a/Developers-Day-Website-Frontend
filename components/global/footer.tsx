...
export default function Footer() {
  const footerLinks = [
    ...
    { name: "EVENT_ITINERARY", href: "/event-itinerary" },
      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            <Image src="/logo.png" alt="DevDay Logo" width={40} height={60} className="object-contain" />
            <h3 className="text-2xl font-bold">DEVDAY '26</h3>
          </div>
          <p className="text-gray-400 text-sm max-w-2xl mx-auto leading-relaxed">
            DevDay'26 is a premier developer competition where talented innovators come together to
            showcase their skills, creativity, and problem-solving abilities, pushing boundaries and
            competing to achieve excellence.
          </p>
        </div>
