    ...
    <section className="bg-dark-red text-white py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex gap-4 mb-12 md:mb-16">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">CONTACT_US</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-6">
            ...
            <ContactCard title="GENERAL_INQUIRIES">
              ...
              <div className="flex items-center gap-3 bg-red-primary p-4">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" />
                </svg>
                <span className="text-white font-mono text-sm">devday26@nu.edu.pk</span>
              </div>
            </ContactCard>

            {/* Operational Inquiries */}
            <ContactCard title="OPERATIONAL_INQUIRIES" subtitle="CONNECTION_REQUIRED">
              <div className="space-y-4">
                {operationalContacts.map((contact, index) => (
                  <div key={index} className="border-b border-gray-800 pb-4 last:border-0">
                    <p className="text-gray-500 text-xs font-mono mb-2">{contact.category}</p>
                    <div className="flex justify-between items-center">
                      <p className="text-white text-sm font-bold">{contact.name}</p>
                      <div className="text-right">
                        <p className="text-red-primary text-xs font-mono">{contact.label}</p>
          ...
          <ContactCard title="">
            ...
            <div className="mt-4 bg-white text-black p-4">
              ...
              <p className="text-sm text-gray-700">
                ST-4, Sector 17-D, National Highway 5, Karachi City, Sindh, Pakistan
              </p>
            </div>
            <div className="flex gap-4 mt-4">
              <Button
                ...
                radius="none"
                startContent={<Image src="/icons/location.svg" alt="Location" width={13} height={13} />}
              >
                OPEN_IN_MAPS
              </Button>
              <Button
                ...
                radius="none"
                startContent={<Image src="/icons/share.svg" alt="Share" width={20} height={20} />}
              >
                SHARE_LINK
              </Button>
            </div>
