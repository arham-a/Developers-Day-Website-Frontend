...
export default function TestimonialCard({ id, name, role, testimonial, avatar }: TestimonialCardProps) {
  return (
    <div className="relative bg-dark-red p-4 md:p-6 w-[280px] h-[200px] md:w-[380px] md:h-[230px] flex-shrink-0 flex flex-col overflow-hidden">
      {/* Gray corner edges */}
      <div className="absolute top-0 left-0 w-5 h-5 md:w-6 md:h-6 border-t-2 border-l-2 border-gray-600" />
      <div className="absolute top-0 right-0 w-5 h-5 md:w-6 md:h-6 border-t-2 border-r-2 border-gray-600" />
      <div className="absolute bottom-0 left-0 w-5 h-5 md:w-6 md:h-6 border-b-2 border-l-2 border-gray-600" />
      <div className="absolute bottom-0 right-0 w-5 h-5 md:w-6 md:h-6 border-b-2 border-r-2 border-gray-600" />
